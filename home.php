    ...
    <div id="rewiev">
        <div class="rewiev-block">
            <img src="img/home/quality.jpg" alt="quality"/>
            <p> Original Air Force Nike patike, <br/> uz koje ide i originalna kutija sa mini crtežom vašeg dizajna.</p>
        </div>
        <div class="rewiev-block">
            <img src="img/home/color.jpg" alt="colors"/>
            <p> Koristimo Angelus najbolje boje, <br/> vodootporne su, patike se lako čiste a boja i crtež se ne skidaju.</p>
        </div>
        <div class="rewiev-block">
